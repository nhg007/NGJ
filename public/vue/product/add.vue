<template>
    <el-dialog :title="title" :visible.sync="dialogFormVisible" width="800px" top="3vh">
        <el-form :model="form" :rules="rules" ref="form" v-loading="loading">
            ...
            <el-form-item label="数量" :label-width="formLabelWidth" prop="number">
                <el-input-number v-model.number="form.number" :min="0" :max="999" autocomplete="off" style="width: 200px"></el-input-number>
            </el-form-item>
            <el-form-item label="在庫状況" :label-width="formLabelWidth">
                <el-select v-model="form.stock_status" placeholder="在庫状況を選択してください">
    ...
    module.exports = {
        ...
        data() {
            ...
            return {
                ...
                rules: {
                    name: [
                        { required: true, message: '商品名を入力してくだい', trigger: 'blur' },
                    ],
                    column: [
                        { required: true, message: '内容量を入力してくだい', trigger: 'blur' },
                    ],
                    price: [
                    ...
                    number: [
                        { required: true, message: '販売数量を入力してくだい', trigger: 'blur' },
                    ]
                },
                imageUrl :''
            }
