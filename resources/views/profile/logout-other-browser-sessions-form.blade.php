<x-jet-action-section>
    ...
    <x-slot name="content">
        ...
        <div class="flex items-center mt-5">
            <x-jet-button class="bg-green-800 hover:bg-green-700 active:bg-green-900 focus:border-green-900 focus:shadow-outline-green" wire:click="confirmLogout" wire:loading.attr="disabled">
